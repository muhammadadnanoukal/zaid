...
class SaleOrder(models.Model):
    ...
    def action_confirm(self):
        ...
        print('whhhhhhhhhhhhhhhhhhhh')
        idss = self.env['crm.stage'].search([]).ids[3]
        seq = self.env['crm.stage'].search([('id', '=', idss)]).sequence
        print(
            self.procurement_group_id.mrp_production_ids.move_dest_ids.group_id.sale_id.opportunity_id.stage_id.sequence)
        print(seq)
            ...
            for sale in sale_order_ids:
                ...
                for stage in stages:
                    ...
                    if stage.state == 'manufacturing' and stage.manufacturing_selection == 'confirmed':
                        print('2')
                        print(self.procurement_group_id.mrp_production_ids)
